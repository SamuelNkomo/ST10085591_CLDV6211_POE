...
namespace ST10085591_CLDV6211_POE.Controllers
{
    public class InspectorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Inspector_no,InspectorName,Email,Phone,id")] Inspector inspector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Inspector_no,InspectorName,Email,Phone,id")] Inspector inspector)
        {
            if (ModelState.IsValid)
            {
